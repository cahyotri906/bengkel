...
<form method="post">
	...
	?>
            ...
            <td class="text-center" style="vertical-align:middle;">
              <a href="pembelian-ubah.php?id=<?php echo $row['id_pembelian'] ?>" class="btn btn-warning"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
            
            <b class="text-center" style="vertical-align:middle;">
    		  <a href="pembelian-hapus.php?id=<?php echo $row['id_pembelian'] ?>" onclick="return confirm('Yakin ingin menghapus data')" class="btn btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a></b>
    	    </td>
